...
var url = 'https://webapi.amap.com/maps?v=1.4.15&key=f9d2a4291a8c1899397625dc9bc8646e' + drivingUrl + geocoderUrl;
...
function planningRoute(city, address){
    driving.search([
        ...
        if (status === 'complete') {
            ...
            var planDistance = result.routes[0].distance * 0.001
