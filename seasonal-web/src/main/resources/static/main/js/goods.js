            ...
            $.each(data, function (k, v) {//所有goods_show的kv对(如专利分格：value)
                ...
                $.each(v.classify, function (j, goodsShowNavItem) {//遍历所有商品类导航
                    ...
                    if (rightIndex === 0) {
                        ...
                        $goodsShowNavUl.append('<li class="goods_show_nav_ul_li" ><a href="getGoodsList.html?classifyId=' + goodsShowNavItem.id + '">' + goodsShowNavItem.classifyName + '</a></li><li>|</li>');//添加商品导航
